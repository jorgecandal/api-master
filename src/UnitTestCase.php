...
class UnitTestCase extends \PHPUnit\Framework\TestCase
{
  public function getDoctrineEntityManagerMock()
  {
    ...
    $em->expects($this->any())->method('persist')->will($this->returnValue(null));
    $em->expects($this->any())->method('merge')->will($this->returnValue(null));
    $em->expects($this->any())->method('remove')->will($this->returnValue(null));
    $em->expects($this->any())->method('flush')->will($this->returnValue(null));
